...
{
    internal static readonly Dictionary<string, string[]> ColumnAliases =
    ...
    internal static CanonicalTransaction? MapRow(
        ...
        Guid loadId)
    {
        ...
        var merchantName =
            ...
            GetFirstValue(row, "merchant_name_alt") ??
            description;
    ...
    internal static string? GetFirstValue(Dictionary<string, string> row, string canonicalField)
    {
    ...
    internal static string? NormalizeMerchantName(string? merchantName)
    {
    ...
    internal static string BuildDedupKey(CanonicalTransaction tx)
    {
        var raw = string.Join("|",
            tx.BusinessId.ToString(),
            tx.BusinessKey,
